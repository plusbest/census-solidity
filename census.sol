...
contract Census {
    ...
    function updateHouse(uint newnum, string memory newname) public {
        houses[msg.sender] = House(newnum, newname);
        houseCount++;
    }
    ...
    function addPerson(uint _age) public {
        ...
        // TODO: Look into SCOPE of array.
        residents.push(people[personCount]);
        
        // Increase global person ID
        personCount++;
    }
    
    function addResidents() internal pure {
        // TODO: Add residents list to current home
    }
}
